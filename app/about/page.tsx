...
//   return (
//     <div className="m-1 bg-white text-gray-800">
//       {/* Hero Section */}
...
export const metadata: Metadata = {
  title: "About Us | Argo Navis Global",
  description: "Learn about Argo Navis Global, your expert military equipment supplier headquartered in India.",
}
